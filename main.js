...
global.root_url = 'https://business.eprompto.com/moksh/itam_backend_end_user';
...
autoUpdater.on('update-downloaded', () => {
  notifier.notify(
    {
      title: 'ITAM Version 2.0.65 Released. Click to Restart Application.', //put version number of future release. not current.
